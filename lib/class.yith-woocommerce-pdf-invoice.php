			...
			<div class="invoice-information">
				<?php if ( ( null != $invoice ) && $invoice->exists ) : ?>
					...
					<div style="clear: both; margin-top: 15px">
						<a class="button tips ywpi_view_invoice" data-tip="<?php _e( "View invoice", "ywpi" ); ?>"
						   href="<?php echo ywpi_document_nonce_url( YITH_YWPI_VIEW_INVOICE_ARG_NAME, $invoice ); ?>"><?php _e( "Invoice", "ywpi" ); ?></a>
						<a class="button tips ywpi_cancel_invoice" data-tip="<?php _e( "Cancel invoice", "ywpi" ); ?>"
						   href="<?php echo ywpi_document_nonce_url( YITH_YWPI_RESET_INVOICE_ARG_NAME, $invoice ); ?>"><?php _e( "Invoice", "ywpi" ); ?></a>
					</div>
				<?php else : ?>
					<p>
						<a class="button tips ywpi_create_invoice" data-tip="<?php _e( "Create invoice", "ywpi" ); ?>"
						   href="<?php echo ywpi_document_nonce_url( YITH_YWPI_CREATE_INVOICE_ARG_NAME, $invoice ); ?>"><?php _e( "Invoice", "ywpi" ); ?></a>
					</p>
				<?php
				endif; ?>
					...
					<?php if ( ( null != $shipping ) && $shipping->exists ) : ?>
						<div style="clear: both; margin-top: 15px">
							<a class="button tips ywpi_view_shipping_list"
							   data-tip="<?php _e( "View shipping list", "ywpi" ); ?>"
							   href=" <?php echo ywpi_document_nonce_url( YITH_YWPI_VIEW_SHIPPING_LIST_ARG_NAME, $shipping ); ?>"><?php _e( "Shipping", "ywpi" ); ?></a>
							<a class="button tips ywpi_cancel_shipping_list"
							   data-tip="<?php _e( "Cancel shipping list", "ywpi" ); ?>"
							   href="<?php echo ywpi_document_nonce_url( YITH_YWPI_RESET_SHIPPING_LIST_ARG_NAME, $shipping ); ?>"><?php _e( "Shipping", "ywpi" ); ?></a>
						</div>
					<?php else : ?>
						<p>
							<a class="button tips ywpi_create_shipping_list"
							   data-tip="<?php _e( "Create shipping list", "ywpi" ); ?>"
							   href="<?php echo ywpi_document_nonce_url( YITH_YWPI_CREATE_SHIPPING_LIST_ARG_NAME, $shipping ); ?>"><?php _e( "Shipping", "ywpi" ); ?></a>
						</p>
					<?php
					endif;
				}?>
